...
import kz.iitu.bussystem.payload.request.LoginRequest;
import kz.iitu.bussystem.payload.request.SignupRequest;
import kz.iitu.bussystem.payload.response.JwtResponse;
import kz.iitu.bussystem.payload.response.MessageResponse;
...
//        User user = userRepository.findById(id).orElseThrow(() -> new NullPointerException("No data found!"));
//        user.setRoles(roles);
//        if (userRepository.existsByUsername(signUpRequest.getUsername())) {
//            return ResponseEntity
//                    .badRequest()
